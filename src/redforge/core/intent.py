...
class IntentClassificationStrategy(ABC):
    @abstractmethod
    def classify(self, raw_input: str) -> Optional[IntentType]:
        pass


class GeneralChatStrategy(IntentClassificationStrategy):
    GREETINGS = {
        "hi", "hello", "hey", "yo", "how are you", "thanks", "thank you",
...
class IntentService:
    ...
    def process(self, raw_input: str, current_mode: str, session_id: str, current_autonomy: str) -> ParsedIntent:
        ...
        elif current_autonomy == "partial" and intent.risk_level in ["high", "destructive", RiskLevel.HIGH]:
            intent.requires_approval = True
        else:
