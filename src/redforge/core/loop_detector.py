...
class LoopDetector:
    ...
    def compute_state_hash(self, state: dict[str, Any]) -> str:
        ...
        state_subset = {k: v for k, v in state.items() if k in relevant_keys and v}
    ...
    def record_state(self, state: dict[str, Any]) -> None:
        ...
        self._state_history.append(
            {"hash": state_hash, "timestamp": datetime.now(), "iteration": self._iteration}
        )
        self._iteration += 1
    ...
    def mark_progress(self, message: str) -> None:
        ...
        self._progress_markers.append(
            {"message": message, "timestamp": datetime.now(), "iteration": self._iteration}
        )

    def detect_loop(self, current_state: dict[str, Any] | None = None) -> LoopDetectionResult:
    ...
    def _generate_message(self, is_looping: bool, loop_count: int, suggestions: list[str]) -> str:
