...
def detect_platform() -> PlatformInfo:
    ...
    if system == "darwin":
        ...
        ):  # nosec B110 - sw_vers unavailable; version remains empty
...
def check_command_exists(command: str) -> bool:
    ...
    if sys.platform == "win32":
        try:
            ...
            OSError,
            subprocess.SubprocessError,
        ):  # nosec B110 - 'where' unavailable on this Windows install
            pass

    return False


def check_tool_available(tool: str) -> tuple[bool, str | None]:
...
def install_package(package: str, platform_info: PlatformInfo | None = None) -> tuple[bool, str]:
